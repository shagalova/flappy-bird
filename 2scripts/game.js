...
const bird = {
    ...
    update : function() {
        ...
        if(state.current == state.getReady) {
            this.speed = 0;
            this.y = 150; //reset position bird after game over
    ...
    draw : function() {
        if(state.current == state.over) {
            if((score.best - score.value) >= 3) {
                ctx.drawImage(sprite, this.steel.sX, this.steel.sY, this.w, this.h, this.x, this.y, this.w, this.h);
            }
